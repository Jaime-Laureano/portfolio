...
export default function Contact() {
  return (
    <section id="contact" className="relative">
      <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap mb-2">
          ...
          <div className="bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md">
            ...
            <div className="lg:w-1/2 px-6 mt-4 lg:mt-0 lg:mr-px">
              ...
              <a
                ...
                href="mailto: jaime.laureano@icloud.com"
              >
                jaime.laureano@icloud.com
              </a>
              <h2 className="title-font font-semibold text-white tracking-widest text-xs mt-4">
                PHONE
              </h2>
              <p className="leading-relaxed">+351 920 007 059</p>
            </div>
          </div>
        </div>
        <form
